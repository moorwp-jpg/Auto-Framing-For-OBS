...
inline uint8_t clamp_u8(int value) { return static_cast<uint8_t>(std::clamp(value, 0, 255)); }
...
inline uint32_t i422_chroma_index(uint32_t x) { return x / 2; }

inline uint32_t i444_chroma_index(uint32_t x) { return x; }
...
inline uint8_t i010_sample_to_u8(uint16_t raw_sample) { return sample10_to_u8(raw_sample); }

inline uint8_t p010_sample_to_u8(uint16_t raw_sample) { return sample10_to_u8(static_cast<uint16_t>(raw_sample >> 6)); }
